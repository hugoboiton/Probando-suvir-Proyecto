...
public class menu extends javax.swing.JFrame {
 ...
 this.hide();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     ruta=(f.toString());
      AnalizadorLexico ana=new AnalizadorLexico(lis);
     ana.analizar(ruta);
     lis.imprimir();
     agregar=AnalizadorLexico.agregar;
     modificar=AnalizadorLexico.modificar;
     eliminar=AnalizadorLexico.eliminar;
     lista=AnalizadorLexico.listado;
     InterFaz in = new InterFaz(lis);
